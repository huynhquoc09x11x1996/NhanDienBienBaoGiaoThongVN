...
import com.hbq.demoluanvan.env.BorderedText;
...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    // use a model tat's been produced from the TensorFlow for Poets codelab,
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        LOGGER.e("InferenceTime", "+++++" + String.valueOf(lastProcessingTimeMs) + " ms");
