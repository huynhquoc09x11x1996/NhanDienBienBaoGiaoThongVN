...
package com.hbq.demoluanvan.env;
...
public class ImageUtils {
    ...
    public static Rect paddingRect(Rect rect, int px, int width, int height) {
        return new Rect(
                (rect.x - px < 0) ? 0 : rect.x - px
                , (rect.y - px < 0) ? 0 : rect.y - px
                , (rect.width + px + px > width) ? width : rect.width + px + px
                , ((rect.height + px + px) > height) ? height : rect.height + px + px);
    }
}
